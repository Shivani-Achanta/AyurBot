...
function PatientNavbar() {
  ...
  const [profilePicUrl, setProfilePicUrl] = useState(
    localStorage.getItem("patientProfilePicUrl") || defaultImageUrl
  );

  useEffect(() => {
    localStorage.setItem("patientProfilePicUrl", profilePicUrl);
  }, [profilePicUrl]);
  ...
  return (
    <Header>
      ...
      <Nav>
        <CustomNavLink exact to="/patient-home">
          Home
        </CustomNavLink>
